...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1ffae23d6; // cvdvir wallet prefix
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(10000000000000000); // 100 Million

const uint32_t EMISSION_SPEED_FACTOR                         = 22;  
...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(2000000000000000); 



const char     GENESIS_COINBASE_TX_HEX[]                     = "011901ff00018080b4ccd4dfc603027e4e03354ffae4a5efa3471fa1864026e56d73bfabeb743c808696fbbd540bae2101ef2066cd672516383877663edf922ca61accafffe166cb0714f568bc03ca37f5";
...
const char     CRYPTONOTE_NAME[]                             = "COVID-19";
...
const int      P2P_DEFAULT_PORT                              =  19815;
const int      RPC_DEFAULT_PORT                              =  19816;
const int      SERVICE_DEFAULT_PORT                          =  8978;
...
const char     LATEST_VERSION_URL[]                          = "https://covid19crypto.com/";
const std::string LICENSE_URL                                = "https://covid19crypto.com/";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x02, 0x02, 0x07, 0x10, 0x13, 0x05, 0x15, 0x18, 0x38, 0x77, 0x38, 0x66, 0x23, 0x77, 0x35, 0x21  }
};
